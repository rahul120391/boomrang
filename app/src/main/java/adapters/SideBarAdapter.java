...
public class SideBarAdapter extends BaseAdapter {
    int images[]={R.drawable.iv_sideclose,R.drawable.iv_sideprofile,R.drawable.iv_myfiless,R.drawable.iv_dashboard,R.drawable.iv_contactus,R.drawable.iv_logout};
    String drawer_text[]={"Close","Profile","My Files","Dashboard","Contact us","Logout"};
    Context context;
